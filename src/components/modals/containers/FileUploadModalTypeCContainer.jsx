...
const FileUploadModalTypeCContainer = ({ closeModal }) => {
  return (
...
FileUploadModalTypeCContainer.propTypes = {
  closeModal: PropTypes.func.isRequired,
};


export default FileUploadModalTypeCContainer;